...
exports = module.exports = function (app) {
    ...
    app.get('/api/pages/', [keystone.middleware.api, keystone.middleware.cors], routes.api.page.list);
    app.get('/api/posts/', [keystone.middleware.api, keystone.middleware.cors], routes.api.post.list);
